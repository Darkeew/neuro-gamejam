...
func _ready() -> void:
	...
	dummysprite2d.name = sprite.name + "_shadow"
...
func _physics_process(_delta):		
	...
	if copy_transform != null:
		...
		copy_transform.scale = shadow_scale_offset
...
func _apply_transform() -> void:
	...
	dummysprite2d.position = sprite.global_position + shadow_offset    
...
func _draw():
	...
	r.position -= r.size / 2
	r.size = Vector2(r.size.x, -r.size.y) * shadow_scale_offset
